...
public enum ObjetsSkins {
	...
	////////////////////////////////
	ObjetsSkins(ObjetsList objet, SkinType skinType, Team team, /* Param�tres itemStack du shop ->*/String objetName, Material material, String[] lore /*, autres parametres spécifiques à certaines runes*/) {
		this.objet = objet;
